...
BON_INLINE void bon_w_obj_sized(bon_w_doc* B, bon_size n) {
	bon_w_ctrl_vlq(B, BON_CTRL_OBJ_VLQ, n);
}
...
BON_INLINE void bon_w_list_sized(bon_w_doc* B, bon_size n) {
	bon_w_ctrl_vlq(B, BON_CTRL_LIST_VLQ, n);
}
